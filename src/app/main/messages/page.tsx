...
// import { supabase, getCurrentUser, handleSubscriptionError } from '@/lib/supabaseClient';
// import { useQuery, useMutation, useQueryClient } from '@tanstack/react-query';
// import { Button } from '@/components/ui/button';
// import  Textarea  from '@/components/ui/textarea';
// import { Skeleton } from '@/components/ui/skeleton';
// import { Avatar, AvatarImage, AvatarFallback } from '@/components/ui/avatar';
// import { Send, Check, CheckCheck, ChevronDown, Menu, X, Reply } from 'lucide-react';
...
//       router.push(`/main/messages?userId=${mostRecentUser.id}`);
//     }
...
//           sender:profiles!sender_id(username, avatar_url, user_type)
//         `
//         )
//         .or(
...
//     // Fetch sender profile only if necessary
//     let enrichedMessage = { ...message };
//     if (!message.sender) {
//       const { data: senderProfile, error: profileError } = await supabase
//         .from('profiles')
//         .select('username, avatar_url, user_type, id')
...
//               router.push(`/main/messages?userId=${otherUserId}`);
//             }
//           }
//         };
//         fetchNewUserProfile();
...
//     setReplyToMessage(null);
//     router.push(`/main/messages?userId=${userId}`);
//   };
...
//       <Box
//         as="aside"
//         className={`h-screen bg-white dark:bg-gray-800 shadow-lg overflow-y-auto
//           fixed md:static top-0 left-0 transform transition-transform duration-300 z-40
//           ${isSidebarOpen ? 'translate-x-0 w-72' : '-translate-x-full md:translate-x-0 hidden md:block'}`}
//       >
...
//                         ? formatDistanceToNow(new Date(user.lastMessageTime), { addSuffix: true })
//                         : ''}
//                     </p>
//                     {user.unreadCount > 0 && (
...
//                 <AvatarImage
//                   src={messages.find((m) => m.sender_id === chatUserId)?.sender?.avatar_url || ''}
//                   alt={chatUsername || 'User'}
//                 />
