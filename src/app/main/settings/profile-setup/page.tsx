...
export default function ProfileSetupPage() {
  ...
  return (
    <motion.div className={`min-h-screen flex-1 max-h-[100vh] p-4 sm:p-6 ${theme === 'dark' ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'} ${theme === 'system' ? 'bg-gray-900 text-white' : ''}`}>
      <motion.div
