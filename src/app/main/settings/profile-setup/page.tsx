...
//         // Fetch points only for students
//         if (fetchedProfile.user_type === 'student') {
//           await fetchPoints(currentUser.id);
//         } else {
...
//   return (
//     <motion.div className={`min-h-screen p-4 sm:p-6 ${theme === 'dark' ? 'bg-gray-900 text-gray-100' : 'bg-gray-50 text-gray-900'} ${theme === 'system' ? 'bg-gray-900 text-white' : ''}`}>
//       <motion.div
...
//         {profile.user_type === 'student' && (
//           <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 justify-self-end">
...
import Textarea from '@/components/ui/textarea';
import { motion, AnimatePresence } from 'framer-motion';
import { Trophy, User, Camera, Flame } from 'lucide-react';
import * as THREE from 'three';
import { Canvas, useFrame } from '@react-three/fiber';
import { Float, OrbitControls } from '@react-three/drei';
import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from '@/components/ui/select';
