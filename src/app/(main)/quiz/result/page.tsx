...
// import { FileText, Home, Trophy, Award, ArrowLeft } from 'lucide-react';
...
//           setError('Failed to calculate quiz scores');
//           setLoading(false);
//           return;
//         }
...
//     if (!profile && !score && !latestScore && !leaderboardEntry) {
//       fetchData();
//     }

//     // Remove resultState from localStorage when component unmounts
//     return () => {
//       localStorage.removeItem('resultState');
//     };
//   }, [calculateScores, pointsSpring, router, profile, score, latestScore, leaderboardEntry]);
...
//             {/* Top Row: Profile, League, Points, Rank */}
//             <motion.div
...
//               <Button
//                 onClick={() => router.push('/dashboard')}
//                 className="flex items-center py-3 rounded-lg justify-center w-full sm:w-56 bg-gradient-to-r from-green-500 to-green-600 hover:from-green-600 hover:to-green-700 text-white py-3 rounded-lg transition-all duration-300 shadow-md hover:shadow-lg"
//               >
...
// import { Award, FileText, Home, Trophy } from 'lucide-react';
// import { Canvas, useFrame } from '@react-three/fiber';
// import { Card, CardContent } from '@/components/ui/card';
// import { Float, OrbitControls } from '@react-three/drei';
// import { motion, useSpring, useTransform } from 'framer-motion';
...
// function LeagueBadgeMesh({ league }) {
...
// // === Animated Button with Infinite Glow Border ===
// function AnimatedGlowButton({ children, className = '', ...props }) {
//   return (
//     <motion.button
//       {...props}
//       className={`relative overflow-hidden group focus:outline-none ${className}`}
...
//         style={{
//           background: 'conic-gradient(from 0deg, #60a5fa, #a7f3d0, #f472b6, #60a5fa)',
//           filter: 'blur(6px)',
//         }}
//         animate={{
//           rotate: [0, 360],
...
//       />
//       {/* Button content */}
//       <span className="relative z-10 flex items-center justify-center w-full h-full px-6 py-3 font-semibold rounded-lg bg-gradient-to-r from-blue-500 to-blue-600 group-hover:from-blue-600 group-hover:to-blue-700 text-white shadow-md transition-all duration-300">
//         {children}
//       </span>
//     </motion.button>
//   );
...
//                 animate={{ scale: 1 }}
//                 transition={{ duration: 0.5 }}
//                 className={`flex flex-col items-center justify-center p-5 ${theme === 'dark' ? 'bg-gray-800 border border-gray-700' : 'bg-gray-100'} rounded-xl shadow-lg min-h-[170px]`}
//               >
//                 <Avatar className="w-16 h-16 sm:w-20 sm:h-20 dark:border-4 border-blue-500 rounded-full shadow-md mb-2">
//                   {profile.avatar_url ? (
//                     <AvatarImage src={profile.avatar_url} alt={profile.username} />
//                   ) : (
//                     <AvatarFallback className="text-xl sm:text-2xl bg-gray-800 text-blue-400">
...
//                 <p className="text-sm text-gray-400">Previous Points</p>
//                 <p className="font-bold text-lg sm:text-xl text-gray-900 dark:text-gray-100">{previousPoints}</p>
//                 <p className="text-sm text-gray-400 mt-1">New Total</p>
//                 <motion.p
//                   className="font-bold text-xl sm:text-2xl bg-gradient-to-r from-blue-400 to-blue-600 bg-clip-text text-transparent"
//                   initial={{ scale: 0.95 }}
//                   animate={{ scale: 1 }}
...
//         } else {
//           console.error("Unknown error parsing localStorage:", err);
//         }
//       }
//     }
//   }, [pointsSpring]);
...
//     if (!profile && !score && !latestScore && !leaderboardEntry && !streak) {
//       fetchData();
//     }
...
//       localStorage.removeItem('resultState');
//     };
//   }, [calculateScores, pointsSpring, router, profile, score, latestScore, leaderboardEntry, streak]);
...
//       }
//     } else {
//       // Fetch data if no local storage data is available
//       async function fetchData() {
//         try {
//           setLoading(true);
//           setStreakLoading(true);
